...
exports.mockPool = exports.createMockImplementation = exports.setupApiKeyValidation = exports.clearAllMocks = exports.mockTag = exports.mockTask = exports.mockWorkspace = exports.mockHashedApiKey = exports.mockApiKeyId = exports.mockWorkspaceId = exports.mockApiKey = exports.mockQuery = void 0;
...
const setupApiKeyValidation = () => {
    ...
    exports.mockQuery.mockImplementation((query, params) => {
        if (query.includes("SELECT id, workspace_id FROM api_keys")) {
            ...
            if (workspaceId === exports.mockWorkspaceId &&
                providedHashedKey === exports.mockHashedApiKey) {
                return Promise.resolve({
                    rows: [{ id: exports.mockApiKeyId, workspace_id: exports.mockWorkspaceId }],
                    rowCount: 1,
                });
            }
