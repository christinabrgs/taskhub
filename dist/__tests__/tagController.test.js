...
describe("Tag Controller", () => {
    ...
    describe("PUT /workspaces/:wsId/tags/:name", () => {
        it("should create a new tag successfully", async () => {
            ...
            expect(response.body.tag.workspace_id).toBe(testHelpers_1.mockWorkspaceId);
        });
        ...
        it("should return 401 for missing API key", async () => {
            const response = await (0, supertest_1.default)(index_1.default).put(`/workspaces/${testHelpers_1.mockWorkspaceId}/tags/urgent`);
